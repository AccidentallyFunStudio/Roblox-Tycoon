return table.freeze({
	...
	Shop_Tab_Active_BG = Color3.fromRGB(255, 214, 120), -- warm pastel gold
	Shop_Tab_Inactive_BG = Color3.fromRGB(235, 235, 235), -- soft neutral gray
	Shop_Tab_Active_Text = Color3.fromRGB(180, 90, 0), -- deep orange-brown
	Shop_Tab_Inactive_Text = Color3.fromRGB(140, 140, 140), -- muted gray
})